...
* A <a href="https://pypi.org/project/littlesis/">Python package</a> to interact with the database on LittleSis.org, which aims to offer transparency on financial activity and other connections amongst people with power. This package I made simplifies the experience interacting with LittleSis API for Python users.  
